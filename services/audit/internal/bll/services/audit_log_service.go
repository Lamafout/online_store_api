...
import (
	...
	uowpkg "github.com/Lamafout/online-store-api/services/audit/internal/dal/unit_of_work"
...
func (s *AuditService) LogOrder(ctx context.Context, msg *contracts.OrderCreatedMessage) error {
